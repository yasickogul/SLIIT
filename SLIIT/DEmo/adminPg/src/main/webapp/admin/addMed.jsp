						...
						<form action="addMed" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label for="formGroupExampleInput">Medicine name:</label> <input
									type="text" class="form-control" id="formGroupExampleInput" name="mName">
							</div>
							<div class="form-group">
								<label for="formGroupExampleInput2" name="category">Select category</label> <select
									class="form-control">
							...
							<div class="form-group">
								<label for="formGroupExampleInput">Price :</label> <input
									type="text" class="form-control" id="formGroupExampleInput" name="price">
							</div>
							...
							<div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio"
										name="Status" id="inlineRadio2" value="inStock">
									<label class="form-check-label" for="inlineRadio2">In Stock</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio"
										name="Status" id="inlineRadio2" value="outOfStock">
							...
							<div class="form-group">
								<label for="formGroupExampleInput">Enter manufacturer:</label> <input
									type="text" class="form-control" id="formGroupExampleInput" name="manuFac">
							</div>

							<div class="form-group">
								<label for="formGroupExampleInput">Expiary date:</label> <input
									type="text" class="form-control" id="formGroupExampleInput" name="exp">
							</div>


							<div class="form-group">
								<label for="formGroupExampleInput" name="img">Add image :</label> <input
